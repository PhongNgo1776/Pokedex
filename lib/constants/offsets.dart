...
const EdgeInsets allInsets3 = EdgeInsets.all(3);
const EdgeInsets allInsets2 = EdgeInsets.all(2);
...
const EdgeInsets horizontalInsets7 = EdgeInsets.symmetric(horizontal: 7);
...
const EdgeInsets verticalInsets2 = EdgeInsets.symmetric(vertical: 2);
...
const EdgeInsets leftRightInsetsBaseXs = EdgeInsets.only(left: base, right: xs);
const EdgeInsets leftRightInsetsXsBase = EdgeInsets.only(left: xs, right: base);
